...
sys.path.append('../')
import constants
from utils import (convert_meters_to_pixels_distance, 
...
class MiniCourt:
    ...
    def convert_meters_to_pixels(self, meters):
        return convert_meters_to_pixels_distance(meters, 
                                                constants.DOUBLE_LINE_WIDTH, 
                                                self.court_drawind_width)
    ...
    def set_court_drawing_keypoints(self):
        ...
        #point 3
        drawing_key_points[6] = drawing_key_points[0] + self.court_drawind_width
        drawing_key_points[7] = drawing_key_points[5]
        #point 4
        drawing_key_points[8] = drawing_key_points[0] +  self.convert_meters_to_pixels(constants.DOUBLE_ALLEY_DIFF)
        drawing_key_points[9] = drawing_key_points[1] 
        # #point 5
        drawing_key_points[10] = drawing_key_points[4] + self.convert_meters_to_pixels(constants.DOUBLE_ALLEY_DIFF)
        drawing_key_points[11] = drawing_key_points[5] 
        # #point 6
        drawing_key_points[12] = drawing_key_points[2] - self.convert_meters_to_pixels(constants.DOUBLE_ALLEY_DIFF)
        drawing_key_points[13] = drawing_key_points[3] 
        # #point 7
        drawing_key_points[14] = drawing_key_points[6] - self.convert_meters_to_pixels(constants.DOUBLE_ALLEY_DIFF)
    ...
    def set_court_lines(self):
        self.lines = [
            (0, 2), (4, 5), (6,7), (1,3), (0,1), (8,9), (10,11), (10,11), (2,3)
        ]
    ...
    def set_mini_court_position(self):
        ...
        self.court_drawind_width = self.court_end_x - self.court_start_x
    ...
    def draw_court(self, frame):
        ...
        cv2.line(frame, net_start_point, net_end_point, (100, 0, 0), 2)
        return frame
    ...
    def get_start_point_ofèmini_court(self):
        return(self.court_start_x, self.court_start_y)
    
    def get_width_of_mini_court(self):
        return self.court_drawind_width
    ...
    def draw_points_on_mini_court(self, frames, positions, color=(0, 0, 0)):
    ...
    # def convert_bbox_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
    #     player_heights = {
    #         1: constants.PLAYER_1_HEIGHT,
    #         2: constants.PLAYER_2_HEIGHT
    #     }
    ...
    #     for frame_num, player_bbox in enumerate(player_boxes):
    #         if not ball_boxes[frame_num]:  # Vérifier si la balle est détectée
    #             continue
                
    #         ball_box = ball_boxes[frame_num][1] if len(ball_boxes[frame_num]) > 1 else None
            
    #         if ball_box is None:  # Assurez-vous que la balle est détectée
    #             continue

    #         ball_position = get_center_of_bbox(ball_box)
    #         if not player_bbox:  # Vérifier si les joueurs sont détectés
    #             continue
    ...
    #             # Obtenir le point clé le plus proche
    #             closest_keypoint_index = get_closest_keypoint_index(foot_position, original_court_key_points, [0, 2, 12, 13])
    #             closest_key_point = (original_court_key_points[closest_keypoint_index * 2],
    #                                 original_court_key_points[closest_keypoint_index * 2 + 1])

    #             # Obtenir la hauteur du joueur en pixels
    #             frame_index_min = max(0, frame_num - 20)
    #             frame_index_max = min(len(player_boxes), frame_num + 50)
    #             bbox_height_in_pixels = [get_height_of_bbox(player_boxes[i][player_id]) for i in range(frame_index_min, frame_index_max)]
    #             max_player_height_in_pixels = max(bbox_height_in_pixels) if bbox_height_in_pixels else 0
    ...
    #         # Ajout des coordonnées des joueurs à la liste de sortie
    #         output_player_boxes.append(output_player_bboxes_dict)
    ...
    #                 cv2.circle(frame, (x, y), 5, color, -1)
    #     else:
    #         print(f"Frame {frame_num} is out of bounds for positions.")
    #     return frames